      ...
      for (var item in inventory) {
        ...
        for (var category in categories) {
          ...
          for (var detail in items) {
            // Add displayName, typeOptions, and sizes to the dropdownItems list
            dropdownItems.add({
              'displayName': detail['displayName'],
              'typeOptions': detail['typeOptions'],
              'sizes': (detail['size'] as List).join(', '), // Assuming size is a list
            });
          }
        }
      }
               ...
               const Padding(
                  ...
                  ...dropdownItems.map((Map<String, String> item) {
                    return _buildCustomRow(
                      ...
                      subtitle: 'Type Options: ${item['typeOptions']} | Sizes: ${item['sizes']}', // Use fetched typeOptions and sizes
